    ...
    return (
      <React.Fragment>
        {(rowsPerPage > 0
          ...
          <TableCell key={numFunc(igBlk) + nameProp}>
            {numFunc(igBlk)}
          </TableCell>
        ))}
      </React.Fragment>
          ...
          <TableBody>
            <TableRow>
              ...
              {(rowsPerPage > 0
                ...
                <TableCell key={igBlk.height + "height"}>
            ...
            <TableRow>
              ...
              <TextCells igBlocks={mTx.ignoringBlocks} numFunc={(igblk) => igblk.txsInMinedBlock} nameProp={"TxsInMinedBlock"} />
            </TableRow>
            <TableRow>
